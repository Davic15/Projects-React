export const projects = [
    {
        ...
        'title02': 'yes/no API',
        'title03': 'JS Project',
        'description01': 'This is a basic project, that makes a simple API call and uses its response to work with the interface.',
    ...
    },
    {
        ...
        'title02': 'Forecast',
        'title03': 'JS Project',
        'description01': 'Weather webapp is a beginner project that includes the weather API. The project consist in asking for the user input (city) and manipulate the data before showing to the user.',
    ...
    },
    {
        ...
        'description02': 'The documentation is huge, but just the most relevant parameters were used.',
